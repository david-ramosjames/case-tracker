...
export function AchievementCard({
  ...
  return (
    <div className="rounded-lg border bg-white p-4">
      ...
      <p className="mt-1 text-3xl font-semibold tracking-tight text-navy-950">{percent(achievedPercent)}</p>
    ...
    <div className="rounded-lg border bg-white p-4">
      <div className="mb-3 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3 text-[11px] text-muted-foreground">
          ...
          <span className="flex items-center gap-1.5">
            <span className="h-2.5 w-2.5 rounded-sm bg-navy-950" />
            Actual
          </span>
        </div>
      </div>
        ...
        {rows.map((row) => (
          <div key={row.label} className="flex flex-col items-center gap-2">
            <div className="flex h-28 w-full items-end justify-center gap-1.5">
              ...
              />
              <div
                className="w-4 rounded-t bg-navy-950"
            ...
            <div className="text-center">
              ...
              <p className="text-[10px] leading-tight text-muted-foreground">{percentOfGoal(row.actual, row.target)}</p>
            </div>
          </div>
        ))}
      </div>
